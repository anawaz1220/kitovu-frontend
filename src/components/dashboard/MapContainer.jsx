...
const StableFarmGeometry = memo(({ farm, isSelected, onClick }) => {
  ...
  <div className="bg-white rounded-lg overflow-hidden shadow-md" style={{ minWidth: "260px", maxWidth: "300px" }}>
    ...
    <div className="p-3">
      ...
      {(farm.farm_type === 'crop_farming' || farm.farm_type === 'mixed_farming') && farm.crop_type && (
        <div className="mb-2">
          <div className="flex items-center mb-1">
            <svg className="w-4 h-4 text-kitovu-purple mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Livestock info (if available) */}
      {(farm.farm_type === 'livestock_farming' || farm.farm_type === 'mixed_farming') && farm.livestock_type && (
        <div className="mb-2">
          <div className="flex items-center mb-1">
            <svg className="w-4 h-4 text-kitovu-purple mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Animal count (if available) */}
      {(farm.farm_type === 'livestock_farming' || farm.farm_type === 'mixed_farming') && farm.number_of_animals && (
        <div className="mb-2">
          <div className="flex items-center mb-1">
            <svg className="w-4 h-4 text-kitovu-purple mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="bg-gray-50 px-3 py-2 text-xs text-gray-500 border-t">
      <div className="flex items-center">
        ...
        Added on {farm.created_at ? new Date(farm.created_at).toLocaleDateString() : 'Unknown date'}
      </div>
    </div>
  </div>
</Popup>
